...
# Disable orenable input for a node
...
func set_show_analysable(flag_advise: bool, flag_advise_ext: bool):
	var a_advise = get_node_or_null("GridContainer/MarginContainer/VBoxContainer/AnalysableAdvise")
	if flag_advise:
		a_advise.visible = true
	else:
		a_advise.visible = false
